export const TEST_TABLE_COLUMNS: Array<{ key: string; value: string }> = [
    {
        key: 'test1',
        value: '테스트1',
    },
...
export const BOOKCOLUMNS: Array<any> = [
    {
        key: 'username',
        value: '예약자명',
    },
...
export const CommunityAdminColumns: Array<{ key: string; value: string }> = [
    { key: 'displayId', value: '번호' },
    { key: 'title', value: '제목' },
    { key: 'userId', value: '작성자' },
    { key: 'createdAt', value: '작성일' },
